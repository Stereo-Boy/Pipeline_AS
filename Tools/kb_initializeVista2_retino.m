...
if ~exist('subj','var'); beep; subj = input('What is the subject ID?','s'); end
if ~exist('sess_path','var');beep; sess_path = input('What is the mrvista session path?','s'); end
