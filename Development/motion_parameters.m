function bad_trs = motion_parameters(mc_dir, vox_factor)
% bad_trs = motion_parameters(mc_dir, vox_factor)
...
% vox_factor: number to multiply by voxel dimensions as criteria for bad
% TRs (default is 0.5)
%
% Outputs:
