...
% defaults
vars = {'mrtype','field','outfile','coordsfile','ref'};
defaults = {'anatomical', 'map{1}', 'output', [], []};
...
if strcmp(ext, '.mat'),
    ...
    % create nifti
    ni = niftiCreate('fname', outfile, 'data', data, 'pixdim', pixdim, 'qto_xyz', n0.qto_xyz);
    % write nifti
    writeFileNifti(ni);
else % nifti
