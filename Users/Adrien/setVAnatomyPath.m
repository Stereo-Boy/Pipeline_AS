...
%
% ras, 06/2008.
% 2016 Adrien chopin: added a few checks
global HOMEDIR
...
if exist(vANATOMYPATH,'file')==2
    ...
    if exist(mrSessPath, 'file')
        ...
        disp('vANATOMYPATH not set because, certainly, mrSessPath is not correct and session cannot be localized')
    end
else
    warning('file for vANATOMYPATH does not exist and will not be updated.')
end
return
