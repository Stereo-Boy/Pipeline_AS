function o=parameterFile_template_retino(subj_dir, verbose)
...
%         expMrSessionFolder = fullfile(subj_dir,'06_exp_mrSession');
 ...
 % retino epi
    ...
    o.pRFdummyFramesNb = 5;                                     % nb of frames to remove for pRF (first fixation TR)
                                                                % it is usually not necessary to remove them physically but it is if one uses this script of pRF
